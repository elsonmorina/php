  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="movie_name" name="movie_name" value="<?php echo $movie_data['movie_name']?>" >
          <label for="floatingInput">Movie Name</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Movie Description" name="movie_desc" value="<?php echo $movie_data['movie_desc']?>">
          <label for="floatingInput">Movie Description</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Movie Quality" name="movie_quality"value="<?php echo $movie_data['movie_quality']?>">
          <label for="floatingInput">Movie Quality</label>
        </div>
        <div class="form-floating">
          <input type="number" class="form-control" id="floatingInput" placeholder="Movie Rating" name="movie_rating" value="<?php echo $movie_data['movie_rating']?>">
